        ...
        <SidebarLayout menuItems={adminMenuItems} title="Contabilidad">
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-bold text-gray-800">📒 Contabilidad</h1>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {transacciones.map((trans) => (
                                        <tr key={trans.id} className="hover:bg-gray-50">
                                            <td className="px-4 py-3 text-sm text-gray-600">{trans.fecha}</td>
                                            <td className="px-4 py-3 text-sm text-gray-500">{trans.referencia}</td>
                                            <td className="px-4 py-3 text-sm text-gray-800">{trans.concepto}</td>
