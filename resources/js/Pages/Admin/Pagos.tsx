            ...
            <div className="space-y-4 sm:space-y-6" style={{ fontFamily: "'Roboto Condensed', sans-serif" }}>
                ...
                <div className="bg-white rounded-xl shadow-sm p-4 flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#293577] text-sm min-w-[175px] flex-shrink-0"
                    >
                                ...
                                {filteredPagos.map((pago) => (
                                    <tr key={pago.id} className="hover:bg-gray-50">
                                        <td className="px-4 py-3">
                                            <div>
                                                <p className="text-sm font-medium text-gray-800 truncate">{pago.estudiante}</p>
                                                <p className="text-xs text-gray-500 truncate">{pago.grado}</p>
                                            </div>
                                        </td>
                                        <td className="px-4 py-3 text-sm text-gray-600 truncate">{pago.concepto}</td>
                                        <td className="px-4 py-3 text-sm text-gray-800 text-right font-medium whitespace-nowrap">${pago.monto.toLocaleString()}</td>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-600 whitespace-nowrap">{pago.fecha_vencimiento}</td>
                                        <td className="px-4 py-3">
