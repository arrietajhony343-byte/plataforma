...
export default function Notificaciones() {
    ...
    const getNotifStyle = (tipo: string) => {
        switch (tipo) {
            case 'alerta': return { bg: 'bg-red-50', border: 'border-red-400', iconBg: 'bg-red-100 text-red-600', icon: '⚠️' };
            case 'nota': return { bg: 'bg-blue-50', border: 'border-blue-400', iconBg: 'bg-blue-100 text-blue-600', icon: '📝' };
            case 'actividad': return { bg: 'bg-green-50', border: 'border-green-400', iconBg: 'bg-green-100 text-green-600', icon: '📅' };
            case 'pago': return { bg: 'bg-yellow-50', border: 'border-yellow-400', iconBg: 'bg-yellow-100 text-yellow-600', icon: '💳' };
            case 'mensaje': return { bg: 'bg-purple-50', border: 'border-purple-400', iconBg: 'bg-purple-100 text-purple-600', icon: '💬' };
            case 'sistema': return { bg: 'bg-gray-50', border: 'border-gray-400', iconBg: 'bg-gray-100 text-gray-600', icon: '🔧' };
                ...
                <div className="bg-white rounded-xl shadow-sm p-3">
                    <div className="flex flex-wrap gap-2">
                        {[
                            ...
                            { key: 'alerta', label: '⚠️ Alertas', count: notificaciones.filter(n => n.tipo === 'alerta').length },
